...
const textConfig = {
    ...
    text8: "Gửi",
    text9: "hôm nay em dể thương quá điii <33",
    text10: "em biết mà ^^",
    text11:
      "Cảm ơn chị vì đã thành thật =))",
  ...
  $(document).ready(function () {
    ...
    function switchButton() {
      var audio = new Audio("sound/sound.mp3");// âm thanh nền
      audio.play();
    ...
    function moveButton() {
      var audio = new Audio("sound/sound_Swish1.mp3");// âm thanh bấm trược
      audio.play();
      if (screen.width <= 600) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          Swal.fire({
            ...
            onClose: () => {
              window.location = "index1.html";// chổ này thay link hoặc file vào nè
            },
          });
        }
      });
